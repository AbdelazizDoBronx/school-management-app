...
const QuizPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] text-white p-6 lg:p-12">
        ...
        {!quizFinished && (
          <div className="mb-6">
            <div className="w-full bg-gray-700 rounded-full h-2.5">
              <animated.div
                className="bg-gradient-to-r  bg-blue-500 hover:bg-blue-700 h-2.5 rounded-full"
                ...
                <button
                  ...
                  className={`w-full py-3 text-lg rounded-lg font-semibold focus:outline-none transition duration-300 ease-in-out transform ${
                    selectedAnswers[currentQuestionIndex] === option
                      ...
                      : "bg-gradient-to-r from-gray-800 to-gray-700 text-gray-200 hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-700 hover:text-white"
                  }`}
                >
                  {option}
                </button>
          ...
          <div className="mt-8 flex justify-between items-center">
            {currentQuestionIndex < quizData.questions.length - 1 ? (
              <button
                ...
                className={`btn btn-primary w-full text-white  bg-blue-500 hover:bg-blue-700 rounded-lg focus:outline-none transition duration-200 ease-in-out ${!selectedAnswers[currentQuestionIndex] ? "opacity-50 cursor-not-allowed" : ""}`}
              >
